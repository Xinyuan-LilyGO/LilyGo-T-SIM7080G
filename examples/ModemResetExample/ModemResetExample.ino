...
void setup()
{
    ...
    ***********************************/
    ...
    Serial.println("After 5 seconds power off modem");
    delay(5000);
    ...
    Serial.println("Modem is power down");
    ...
    Serial.println("Modem is power on");
    Serial.println("Modem reset example finished");
}
